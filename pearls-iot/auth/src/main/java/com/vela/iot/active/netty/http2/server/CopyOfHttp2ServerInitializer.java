 ...
 */
public class CopyOfHttp2ServerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public CopyOfHttp2ServerInitializer(SslContext sslCtx) {
        this(sslCtx, 16 * 1024);
    }

    public CopyOfHttp2ServerInitializer(SslContext sslCtx, int maxHttpContentLength) {
